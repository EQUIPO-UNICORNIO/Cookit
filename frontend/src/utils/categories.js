...
export function autoCategorize(name) {
  ...
  if (/pollo|ternera|cerdo|carne|filete|chuleta|solomillo|lomo|cordero|hamburguesa|salchicha|tocino|bacon|jamón|pavo|conejo|chorizo|mortadela|salchichón|butifarra|fuet|longaniza|secreto|presa|costilla|entrecot|rabo|higado|riñón|seso|albóndiga|albondiga|albóndigas|albondigas|magret|magreta/i.test(n)) return 'Carne';
  ...
  if (/lechuga|tomate|cebolla|cebolleta|ajo|pimiento|espinaca|brócoli|coliflor|zanahoria|calabacín|calabaza|berenjena|\bpapa\b|patata|batata|boniato|verdura|acelga|apio|alcachofa|espárrago|champiñón|champiñones|seta|hortaliza|rúcula|canónigo|remolacha|nabo|rábano|jengibre|puerro|perejil|albahaca|cilantro|col|repollo|guisante|haba|judía verde|germinado|berro|endibia|pepino|tofu|edamame|alga nori|alga wakame|brote de soja|bambú/i.test(n)) return 'Verduras';
  if (/manzana|plátano|naranja|limón|lima|fresa|uva|pera|melón|sandía|kiwi|mango|piña|fruta|arándano|cereza|pomelo|higo|ciruela|albaricoque|melocotón|aguacate|coco|papaya|granada|mandarina|frambuesa|mora/i.test(n)) return 'Frutas';
  if (/aceite|sal|pimienta|orégano|canela|especia|laurel|tomillo|romero|curry|pimentón|comino|nuez moscada|clavo|vinagre|mostaza|azafrán|eneldo|salsa|kétchup|ketchup|mayonesa|miel|sirope|azúcar|azucar|edulcorante|levadura|bicarbonato|cacahuete|sésamo|almendra|nuez|nueces|avellana|anacardo|pipa|fruto seco|frutos secos|cacao|miso|wasabi|pasta de curry|aceite de sésamo|vinagre de arroz/i.test(n)) return 'Condimentos';
  ...
  if (/agua|refresco|zumo|vino|cerveza|café|cafe|té|\bte\b|infusión|leche vegetal|bebida|cola|gaseosa|sidra|\bron\b|whisky|vodka|licor/i.test(n)) return 'Bebidas';
  return 'Otros';
}
