...
export function autoCategorize(name) {
  ...
  if (/aceite|sal|pimienta|orégano|canela|especia|laurel|tomillo|romero|curry|pimentón|comino|nuez moscada|clavo|vinagre|mostaza|azafrán|eneldo|salsa|kétchup|mayonesa|miel|sirope|azúcar|edulcorante|levadura|bicarbonato|cacahuete|sésamo|almendra|nuez|avellana|anacardo|pipa|fruto seco/i.test(n)) return 'Condimentos';
