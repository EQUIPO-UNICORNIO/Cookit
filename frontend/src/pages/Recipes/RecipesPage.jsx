...
const RECIPE_DB = [
  ...
  { id: 'r13', name: 'Ensalada de quinoa', category: 'almuerzo', time: '25 min', difficulty: 'Fácil', ingredients: ['Quinoa', 'Pepino', 'Tomate', 'Cebolla roja', 'Aguacate', 'Limón', 'Aceite de oliva', 'Sal'], instructions: '1. Cocina la quinoa según las instrucciones y deja enfriar.\n2. Corta el pepino, tomate y cebolla en dados.\n3. Pela y corta el aguacate.\n4. Mezcla todo con la quinoa fría.\n5. Aliña con limón, aceite de oliva y sal.' },
...
const PANTRY_INGREDIENTS = [
  'Pollo', 'Carne picada', 'Pescado blanco', 'Salmón', 'Atún en lata', 'Huevos',
  'Patatas', 'Arroz', 'Pasta', 'Macarrones', 'Pan', 'Tortillas de trigo', 'Tortillas de maíz',
  'Tomate', 'Cebolla', 'Ajo', 'Pimiento', 'Zanahoria', 'Calabacín', 'Berenjena', 'Calabaza',
  'Lechuga', 'Espinacas', 'Col', 'Judías verdes', 'Champiñones', 'Pepino', 'Aguacate',
  'Plátano', 'Manzana', 'Fresas', 'Limón',
  'Leche', 'Yogur natural', 'Queso', 'Queso cheddar', 'Queso parmesano', 'Nata', 'Mantequilla',
  'Aceite de oliva', 'Sal', 'Pimienta', 'Vinagre', 'Mostaza', 'Ketchup', 'Mayonesa', 'Miel',
  'Pan rallado', 'Harina', 'Avena', 'Granola', 'Lentejas', 'Garrofón', 'Maíz dulce',
  'Cebolla roja', 'Perejil', 'Albahaca', 'Cilantro', 'Eneldo', 'Azafrán', 'Comino', 'Pimentón', 'Pimentón picante',
  'Caldo de pollo', 'Caldo de verduras', 'Tomate triturado',
  'Crema agria', 'Semillas de sésamo', 'Frutos secos', 'Mantequilla de cacahuete', 'Cacao',
  'Jengibre', 'Nuez moscada', 'Orégano',
];
...
export default function RecipesPage() {
  ...
  const filteredSuggestions = searchIngredient
    ? PANTRY_INGREDIENTS.filter(ing => normalize(ing).includes(normalize(searchIngredient)))
    : PANTRY_INGREDIENTS;
