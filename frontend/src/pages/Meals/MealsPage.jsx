    ...
    return (
      <div>
        ...
        <div className="neo-card mb-4">
          ...
          {selectedMeal.photo && (
            <img src={selectedMeal.photo} alt={selectedMeal.name} className="w-full max-h-28 object-contain rounded-xl mt-3 cursor-pointer" onClick={() => setFullPhoto(selectedMeal.photo)} />
          )}
